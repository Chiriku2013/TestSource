...
Window = Fluent:CreateWindow({
    Title = "Mastery Hub-Blox Fruit [Free]",
    SubTitle = "by Qminh(Kenny)",
    TabWidth = 155,
...
Info:AddButton({
    Title = "Discord",
    Callback = function()
        setclipboard("https://discord.gg/d9AH96mJcc")
    end
})
Info:AddButton({
    Title = "Shop Roblox",
    Callback = function()
        setclipboard("https://shoproblox29.cfd/")
    end
})
...
local MasteryHubBtn = Instance.new("ScreenGui")
    ...
    ImageLabel.Image = "rbxassetid://103691718434653"
